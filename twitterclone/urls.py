...
urlpatterns = [
    path('', twitteruser_views.IndexView.as_view(), name="homepage"),
    ...
    path('createtweet/', tweet_views.CreateTweetView.as_view(), name="createtweet"),
    ...
    path('signup/', twitteruser_views.CreateUserView.as_view(), name="signup"),
